    ...
    <script>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("select[name=cgi_taxlocale_id]").on('select2:select', function (e) {
                    ...
                    $("select[name=parent_id] + .select2 .selection").hide();
                    $("select[name=parent_id] + .select2").append("<div class='loading-d'>Chargement...</div> ");
                    
                    $url += '/admin/filters/categories/' + data.id;
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("select[name=parent_id] + .select2 .selection").show();
                            $(".loading-d").remove();
                        },
                        error:function(){ 
                            $("select[name=parent_id] + .select2 .selection").show();
