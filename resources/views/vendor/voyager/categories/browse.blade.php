            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        @if ($isServerSide)
                            <span>Filtrer par : </span> <br>
                            <a href="{{url('/admin/categories?order_by=category_belongsto_cgi_tax_locale_relationship&cgi_taxe_id=1')}} " class="btn btn-primary">CGI</a>
                            <a href="{{url('/admin/categories?order_by=category_belongsto_cgi_tax_locale_relationship&cgi_taxe_id=2')}} " class="btn btn-primary">Taxes locales</a>
                        ...
                        @if ($isServerSide)
                            ...
                            <div class="pull-right">
                                @if(!array_key_exists('cgi_taxe_id',$queries)) 
                                ...
                                @else
                                    <?php $cgi_taxe_id = $queries['cgi_taxe_id']; ?>
                                     {{ $dataTypeContent->appends([
                                        's' => $search->value,
                                        'filter' => $search->filter,
                                        'key' => $search->key,
